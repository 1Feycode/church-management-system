-- ============================================
-- RESET AND SETUP - Complete Fresh Start
-- This will DELETE all existing tables and data, then recreate everything
...
-- ============================================
-- STEP 4: ADD GROUP FOREIGN KEY TO MEMBERS
-- ============================================
ALTER TABLE members 
...
-- ============================================
-- STEP 8: CREATE PRAYER REQUESTS TABLE
-- ============================================
...
-- ============================================
-- STEP 9: CREATE BIBLE STUDIES TABLE
-- ============================================
